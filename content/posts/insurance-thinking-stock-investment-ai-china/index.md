...
In 1977, Elton and Gruber published the foundational empirical study on diversification and the number of stocks required to reduce portfolio risk ([Elton & Gruber, Journal of Business](https://en.wikipedia.org/wiki/Diversification_(finance)), 1977). Their finding: most of the risk reduction comes from the first 15-20 stocks, and by 30 stocks the portfolio's standard deviation approaches that of the fully diversified market. Statman (1987) confirmed that **30 or more stocks** are needed for a well-diversified portfolio, while noting that even 4 carefully chosen stocks provide most of the reduction versus holding a single stock ([Statman, "How Many Stocks Make a Diversified Portfolio?", JFQA](https://en.wikipedia.org/wiki/Diversification_(finance)), 1987).
