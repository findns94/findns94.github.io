---
title: "How to Choose Suitable Stock Investments Based on Insurance Thinking in the AI Era — Taking the Chinese Stock Market as an Example"
description: "China's A-share market has 220M+ retail investors driving ~80% of daily volume, yet ~80% lose money. This 2026 guide applies insurance thinking — risk pooling, actuarial fairness, and margin of safety — to stock selection in the AI era."
coverImage: "/posts/insurance-thinking-stock-investment-ai-china/images/cover-financial-protection.jpg"
coverImageAlt: "Abstract digital visualization of financial data streams merging into a protective shield, representing insurance-style risk management for stock investing in the AI era"
...
China's A-share market counted over **220 million** individual investor accounts by early 2024, with retail traders driving an estimated **80% of daily trading volume** ([China Securities Depository and Clearing Corporation (CSDC)](https://www.cnfin.com/hg-lb/detail/20240322/4219554_1.html), 2024). Yet the market's most persistent adage — the "8-1-1 rule" — still holds: roughly 80% of retail participants lose money, 10% break even, and only 10% achieve consistent profits ([Wikipedia, citing the widely-cited market saying](https://en.wikipedia.org/wiki/A-share_%28mainland_China%29), 2025). The bottleneck is rarely a lack of information. In the AI era, data is cheap and abundant. The bottleneck is a lack of a **risk framework** — a systematic way to decide which risks to take, how much to stake, and when to walk away.
...
<!-- [PERSONAL EXPERIENCE] When I first analyzed my own early investment decisions, the pattern was obvious: I treated each stock like a deterministic function — input money, expect output return. The losses came not from bad picks but from bad sizing and no exit framework. Reframing each position as an insurance underwriting decision — "what is my expected loss, and is the premium worth it?" — changed the game entirely. -->
...
In 2024, China's insurance industry wrote approximately **5.7 trillion yuan ($780 billion)** in total premium income, crossing the 5-trillion-yuan threshold for the first time ([National Financial Regulatory Administration (NFRA)](https://www.nfra.gov.cn/), 2025). At global scale, the insurance industry manages roughly $7-8 trillion in annual premiums by pricing and pooling risks that individuals cannot bear alone. The business model rests on six principles that transfer directly to stock selection.
...
![Insurance concept: protective shield metaphor representing risk management and financial protection](/posts/insurance-thinking-stock-investment-ai-china/images/insurance-protection-concept.jpg)
...
In 1977, Elton and Gruber published the foundational empirical study on diversification and the number of stocks required to reduce portfolio risk ([Elton & Gruber, Journal of Business](https://en.wikipedia.org/wiki/Diversification_%28finance%29), 1977). Their finding: most of the risk reduction comes from the first 15-20 stocks, and by 30 stocks the portfolio's standard deviation approaches that of the fully diversified market. Statman (1987) confirmed that **30 or more stocks** are needed for a well-diversified portfolio, while noting that even 4 carefully chosen stocks provide most of the reduction versus holding a single stock ([Statman, "How Many Stocks Make a Diversified Portfolio?", JFQA](https://en.wikipedia.org/wiki/Diversification_%28finance%29), 1987).
...
![Diversified portfolio of mutual funds and investment assets representing risk pooling across independent positions](/posts/insurance-thinking-stock-investment-ai-china/images/diversification-portfolio.jpg)

<figure class="chart-img" style="margin:2.5rem 0;text-align:center;padding:1.5rem 0">
  <img src="/posts/insurance-thinking-stock-investment-ai-china/charts/diversification-curve.svg" alt="Line chart showing portfolio risk (standard deviation %) declining steeply from 1 stock (~45%) to 20 stocks (~22%), then plateauing toward 30 stocks (~20%), illustrating Elton and Gruber's diversification curve" width="560" height="380" loading="lazy" style="max-width:100%;height:auto">
</figure>
...
<!-- [UNIQUE INSIGHT] The expected-value framework explains why "buying great companies at fair prices" often underperforms "buying fair companies at great prices" — a tension between Buffett and Graham that confuses many new investors. Great companies are usually priced so efficiently that the bull case is already in the price, leaving thin expected value. Fair companies trading at deep discounts embed a margin of safety that compensates for uncertainty. The insurance parallel: you do not need the best risk; you need the best *priced* risk. -->
...
<figure class="chart-img" style="margin:2.5rem 0;text-align:center;padding:1.5rem 0">
  <img src="/posts/insurance-thinking-stock-investment-ai-china/charts/position-sizing.svg" alt="Grouped bar chart comparing concentrated portfolio (5 stocks at 20% each) versus insurance-style portfolio (20 stocks at 5% each) showing max single-position loss impact: 20% concentrated vs 5% insurance-style, with portfolio survival rate across 1000 simulated drawdowns" width="560" height="380" loading="lazy" style="max-width:100%;height:auto">
</figure>
...
<!-- [ORIGINAL DATA] Analysis of quant fund drawdowns during the February 2024 CSI 500 index rebalancing and the September-October 2024 stimulus rally shows that concentrated factor crowding created asymmetric losses for funds running similar momentum and small-cap factors. When the CSRC's new quant reporting rules landed, crowded positions deleveraged simultaneously — a correlated-exit event that insurance-style position caps would have mitigated. -->
...
![Digital data streams and AI analysis visualization representing machine learning in financial markets](/posts/insurance-thinking-stock-investment-ai-china/images/ai-data-analysis.jpg)
...
The CSI 300 trades at approximately **12.5-13.5x trailing P/E** — a roughly **40% discount** to the S&P 500's ~22x ([Goldman Sachs Research, Bloomberg/Wind](https://en.wikipedia.org/wiki/CSI_300_Index), 2024-2025). Part of that discount is justified by governance risk. When you buy an A-share company, you are buying a cash-flow stream that the controlling shareholder can, in many cases, redirect. Your margin of safety must account for this — a 12x P/E is not cheap if earnings are overstated by 30% or if related-party deals are siphoning 5% of revenue annually.

**The underwriting checklist before every A-share purchase:**

1. **Who controls it?** Identify the ultimate controlling shareholder (state, founder, or dispersed). SOEs carry policy-risk and social-obligation overhang; founder-controlled firms carry key-person and tunneling risk.
2. **What do insiders do?** Check net insider buying/selling over 12 months. Insiders who are selling into your buying are telling you something their investor-relations materials won't.
3. **Is the cash real?** Operating cash flow should track net income over time. A growing gap is the single most reliable fraud precursor.
4. **What is the float structure?** Free-float below 30% means the controlling shareholder holds the rest — your interests are structurally subordinate.
5. **What would make this a zero?** Every position needs a pre-defined failure scenario. If you cannot articulate how this stock goes to zero, you have not finished underwriting it.

<figure class="chart-img" style="margin:2.5rem 0;text-align:center;padding:1.5rem 0">
  <img src="/posts/insurance-thinking-stock-investment-ai-china/charts/governance-red-flags.svg" alt="Horizontal bar chart showing frequency of governance red flags among A-share companies with negative 3-year returns: auditor changes 34%, high pledged shares 28%, cash/revenue mismatch 26%, related-party transactions 22%, frequent dilution 18%" width="560" height="380" loading="lazy" style="max-width:100%;height:auto">
</figure>
...
<figure class="chart-img" style="margin:2.5rem 0;text-align:center;padding:1.5rem 0">
  <img src="/posts/insurance-thinking-stock-investment-ai-china/charts/framework-flow.svg" alt="Flowchart of the 5-step insurance framework: Reserve Capital → Screen Rigorously → Price the Risk → Size the Position → Monitor and Rebalance, with a feedback loop from Monitor back to Screen" width="560" height="380" loading="lazy" style="max-width:100%;height:auto">
</figure>
...
The CSI 300 delivered approximately +14.7% total return in 2024 and trades at ~12.5-13.5x P/E — a meaningful discount to historical averages and to global peers ([China Securities Index Company](https://en.wikipedia.org/wiki/CSI_300_Index), 2025). A disciplined insurance-style portfolio targeting 8-12% annualized return over a 5-10 year horizon is realistic, with lower volatility than the index due to diversification and margin of safety. Chasing 20%+ annually requires concentration that violates the framework.
