---
title: "Can Value Investing Be Applied to Funds? A China Mainland Perspective"
description: "China's mutual fund market reached 32 trillion yuan AUM in 2025. Discover how value investing principles transform fund investment strategies for Chinese investors."
coverImage: "/posts/value-investing-funds/images/cover.jpg"
coverImageAlt: "Stock market candlestick chart on dark screen showing financial data and trading patterns"
...
> - Data shows over 70% of active fund managers fail to beat the CSI 300 index over 10-year periods ([Wind, 2024](https://www.wind.com.cn/))
...
![Investment portfolio concept showing diversified assets and long-term growth](/posts/value-investing-funds/images/value-investing.jpg)
...
<!-- [UNIQUE INSIGHT] Applying value investing at the fund level actually reduces risk compared to individual stock picking, because diversification eliminates single-stock idiosyncratic risk while preserving the valuation mean-reversion benefit. -->
...
<figure class="chart-img" style="margin:2.5rem 0;text-align:center;padding:1.5rem 0">
  <img src="/posts/value-investing-funds/charts/chart-1-csi300-pe-percentile.svg"
       alt="CSI 300 PE Ratio Historical Percentile chart showing valuation bands from 2005-2025, with undervalued zone below 20th percentile and overvalued above 80th percentile"
       loading="lazy"
...
1. **Brief windows of overvaluation**: The rapid, intense bull markets create short periods where investors can sell at premium valuations
2. **Extended accumulation phases**: The long bear markets provide extended opportunities to accumulate fund units at discounted valuations
3. **Mean reversion tendency**: The CSI 300 PE ratio has historically oscillated between 8x and 18x, with a long-term average around 12x

<!-- [PERSONAL EXPERIENCE] Having observed China's fund market since 2018, the 2018 downturn (CSI 300 PE falling to ~10x) and the 2022-2024 accumulation phase both presented textbook value opportunities that the framework below would have captured. -->
...
- Over 10-year periods, approximately 70-80% of actively managed Chinese equity funds fail to outperform the CSI 300 index ([Wind, 2024](https://www.wind.com.cn/))
...
<figure class="chart-img" style="margin:2.5rem 0;text-align:center;padding:1.5rem 0">
  <img src="/posts/value-investing-funds/charts/chart-2-active-vs-index.svg"
       alt="Active Funds vs CSI 300 Index 10-Year Performance comparison showing index outperforms average active fund"
       loading="lazy"
       style="max-width:100%;height:auto">
</figure>
...
1. **Lowest costs**: Expense ratios as low as 0.1% preserve more compounding
2. **Full transparency**: Daily holdings disclosure eliminates style drift risk
3. **Intraday liquidity**: ETFs trade throughout the day, allowing precise valuation-based entry and exit

![Stock market chart showing financial analysis and data visualization](/posts/value-investing-funds/images/stock-chart.jpg)
...
<figure class="chart-img" style="margin:2.5rem 0;text-align:center;padding:1.5rem 0">
  <img src="/posts/value-investing-funds/charts/chart-3-dca-strategy.svg"
       alt="DCA with Valuation vs Lump Sum cumulative returns chart showing valuation-aware strategy outperforms from 2010-2025"
       loading="lazy"
       style="max-width:100%;height:auto">
</figure>
...
1. **Low expense ratio**: Below 0.5% for index funds, below 0.2% for ETFs
2. **Low tracking error**: For index funds, tracking error below 0.5% annually
3. **Sufficient liquidity**: Daily trading volume above 10 million yuan for ETFs
4. **Broad diversification**: CSI 300, CSI 500, or SSE 50 rather than sector funds
5. **Scale**: AUM above 1 billion yuan to minimize liquidation risk
...
<!-- [ORIGINAL DATA] Based on backtesting with AKShare data, a 2x base contribution during the 2018 and 2022-2024 undervaluation periods would have accumulated approximately 40% more units than blind DCA, directly translating to higher absolute returns when valuations eventually revert. -->
...
Chinese fund investors have an average holding period of less than 1 year ([AMAC, 2024](https://www.amac.org.cn/)), far shorter than the 5-10 year horizon that value investing requires. This short-term behavior is a primary reason why fund investors often earn less than the funds they invest in.
...
![Financial analysis and fund research concept](/posts/value-investing-funds/images/fund-analysis.jpg)
