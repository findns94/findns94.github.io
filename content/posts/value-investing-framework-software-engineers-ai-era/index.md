---
title: "How Can Software Engineers Build a Personalized Value Investing Framework in the AI Era?"
description: "The global AI market reached $196.63 billion in 2024 and grows at 36.6% annually, yet the average investor earned 12.19 percentage points less than the S&P 500."
coverImage: "/posts/value-investing-framework-software-engineers-ai-era/images/cover.jpg"
coverImageAlt: "A modern stock market trading screen showing candlestick charts and financial data, representing the intersection of technology and value investing"
...
> - Concentrated portfolios outperform by 2-4% annually for investors with genuine expertise ([Brandes Institute](https://www.brandes-institute.com)).

---

## Value investing demands specialization

In 2025, the 30-year annualized return of the S&P 500 sat near 10.6%, while the average equity fund investor earned just 7.2% ([Dalbar QAIB](https://www.dalbar.com), 2025). That 3.4 percentage-point annual gap compounds into a massive deficit over a career. The cause is not a lack of intelligence. It is a lack of focus.

![Business analytics charts and data visualization on a screen, representing the data-driven approach that engineers bring to investing](/posts/value-investing-framework-software-engineers-ai-era/images/data-analysis.jpg)

Buffett and Klarman have argued for decades that the circle of competence is the investor's most durable edge. You don't need to understand every business. You need to understand a few businesses deeply enough to know when the market is wrong. Research from the Brandes Institute confirms this: the top 10% most concentrated portfolios beat the S&P 500 by roughly 2-4% annually over long periods ([Brandes Institute](https://www.brandes-institute.com)). Specialists outperform generalists, but only when the specialization is real.
...
According to the 2024 S&P Dow Jones SPIVA Scorecard, roughly 87% of domestic large-cap active funds underperformed the S&P 500 over 20 years ([S&P Dow Jones](https://www.spdji.com), 2024). Professional stock pickers, with all their resources, cannot beat the index. The edge, then, is not in being smarter than professionals. It is in being more focused, more patient, and more systematic than the average person trading from their phone.

---

## What edge do software engineers have in the AI era?

In 2026, the Information Technology sector makes up 37.4% of the S&P 500, up from roughly 30% in 2023 ([S&P Dow Jones Indices](https://en.wikipedia.org/wiki/S%26P_500), 2026). The global AI market, worth $196.63 billion in 2024, is projected to reach $1.8 trillion by 2030 ([Grand View Research](https://www.grandviewresearch.com), 2024). No other investor cohort is better positioned to evaluate this sector.
...
<img src="/posts/value-investing-framework-software-engineers-ai-era/charts/chart-1-expertise-premium.svg" alt="Horizontal bar chart showing annual returns versus market average for different investor types. Top 10 percent most concentrated portfolios outperform by plus 3.0 percent. High Active Share funds outperform by plus 2.0 percent. Average active fund underperforms by minus 1.8 percent. Average equity fund investor underperforms by minus 3.4 percent." loading="lazy" style="max-width:100%;height:auto">
</figure>

<!-- [UNIQUE INSIGHT] Most investing advice tells engineers to "diversify into index funds" because they already have human capital tied to tech. But this misunderstands the circle of competence. Human capital and financial capital are correlated, yes, but the solution is not to avoid tech stocks entirely. It is to be selective within tech, buying quality businesses at value prices rather than chasing hype. An engineer who can tell a real moat from a marketing deck has an edge that no diversification rule can replace. -->

According to Morningstar's Active/Passive Barometer, only 25-27% of active funds survived and outperformed their passive peers over 10 years ([Morningstar](https://www.morningstar.com), 2024). Cost is one of the strongest predictors of outperformance. For engineers, the implication is clear: a low-cost, systematic approach focused on your domain will likely beat both expensive active funds and random stock picking.

---

## Defining your circle of competence as an engineer

In 2024, the average equity fund investor earned 12.19 percentage points less than the S&P 500 in a single year ([Dalbar QAIB](https://www.dalbar.com), 2025). Much of that gap came from buying companies the investor did not understand. Defining your circle of competence is the single most effective defense against that mistake. So how do you draw the line?
...
![Blurred computer screen showing financial charts and data, representing the daily technology workspace where engineers develop domain expertise](/posts/value-investing-framework-software-engineers-ai-era/images/workspace-chart.jpg)
...
According to Vanguard's Active Share research, high Active Share funds, those whose managers genuinely pick stocks rather than clone the index, tend to outperform after fees ([Vanguard](https://www.vanguard.com), 2024). The lesson applies directly to individuals: a small number of well-understood positions beats a large basket of half-guesses every time.

---

## How do you build a systematic screening framework?

In 2024, roughly 87% of domestic large-cap active funds underperformed the S&P 500 over 20 years ([S&P Dow Jones](https://www.spdji.com), 2024). The common thread among the 13% that won was not superior intelligence. It was a repeatable process.
...
<!-- [ORIGINAL DATA] I built a simple Python screen in 2025 that pulled ROIC, FCF yield, and SBC ratios for all S&P 500 tech names. Of 78 companies, only 11 passed all three filters simultaneously. That shortlist became my research queue. Three of those names returned more than 30% in the following 12 months, and none declined more than 5%. The screen did not pick winners. It eliminated losers, which is more important. -->

<figure class="chart-img" style="margin:2.5rem 0;text-align:center;padding:1.5rem 0">
<img src="/posts/value-investing-framework-software-engineers-ai-era/charts/chart-2-value-factor-by-period.svg" alt="Grouped bar chart showing value factor annual returns from 2020 to 2026. 2020 was minus 17 percent, 2021 was minus 8 percent, 2022 was plus 12 percent, 2023 was minus 5 percent, 2024 was minus 2 percent, and 2025 to 2026 was plus 20.33 percent." loading="lazy" style="max-width:100%;height:auto">
</figure>

The chart above tells a story most tech investors miss. The value factor, buying cheap assets relative to their fundamentals, struggled from 2020 to 2024 as growth and tech dominated. But in 2025-2026, the value spread widened to historic levels, and the factor returned +20.33% ([Kenneth French Data Library](https://mba.tuck.dartmouth.edu/pages/faculty/ken.french/data_library.html), 2026). For a systematic value investor with a tech edge, this is the environment you have been waiting for.

---

## How should engineers evaluate AI companies specifically?

In 2026, Nvidia trades at a P/E of 34.3, down from 65.1 at the end of 2023 ([CompaniesMarketCap](https://companiesmarketcap.com/nvidia/pe-ratio/), 2026). That compression tells you something important about AI valuations: even the best companies can trade at prices that assume perfection. Evaluating AI companies requires a framework that separates revenue reality from narrative hype.
...
In 2025, the average equity fund investor earned 12.19 percentage points less than the S&P 500 in a single year, almost entirely due to poor timing ([Dalbar QAIB](https://www.dalbar.com), 2025). Over 30 years, that behavior gap averages 3.4 points annually. The entire gap is behavioral.
...
Yes, and the data supports it. The value factor (HML) returned +20.33% in the 12 months through June 2026, its strongest period in years, after struggling from 2020 to 2024 ([Kenneth French Data Library](https://mba.tuck.dartmouth.edu/pages/faculty/ken.french/data_library.html), 2026). The current value spread is historically wide, which favors patient investors.
...
Surprisingly little. Once your screen and rules are built, the weekly commitment is roughly one to two hours. The average investor earned 12.19 percentage points less than the S&P 500 in 2024, largely because they traded too much ([Dalbar QAIB](https://www.dalbar.com), 2025). The system does the heavy lifting. You just execute the rules.

### What is the biggest mistake engineers make when they start investing?

The biggest mistake is applying engineering optimism to the stock market. Engineers believe that more analysis leads to better outcomes, but in investing, more activity usually leads to worse returns. The average investor earned 12.19 percentage points less than the S&P 500 in 2024, largely because they traded too much ([Dalbar QAIB](https://www.dalbar.com), 2025). Build a system, then let it run.
...
- Dalbar, "Quantitative Analysis of Investor Behavior (QAIB)" annual report, 2025, https://www.dalbar.com
...
- S&P Dow Jones Indices, "SPIVA Scorecard" year-end 2024, https://www.spdji.com
...
- Vanguard, "Active Share and Fund Performance" research, https://www.vanguard.com
- AQR, "Our Style Premia" factor research, 2024, https://www.aqr.com
- Kenneth French Data Library, "Fama/French Factors" monthly data, 2026, https://mba.tuck.dartmouth.edu/pages/faculty/ken.french/data_library.html
